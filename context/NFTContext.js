...
const projectId = '2OUkkco2n5wOXYI4jF2Q8v9gPyQ';
const projectSecret = '1f1c69b2e7d07d9e5e3f20801e2b7a3c';
...
export const NFTProvider = ({ children }) => {
  ...
  const fetchNFTs = async () => {
    ...
    const provider = new ethers.providers.JsonRpcProvider('https://polygon-mumbai.g.alchemy.com/v2/CqPK_YqXX1Re6Xg61W8--9urVM8NOZNf');
